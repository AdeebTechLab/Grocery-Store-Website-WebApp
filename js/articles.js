/**
 * Groco Reusable Shared Article Database (articles.js)
 * Master dataset shared across index.html, journal.html, and article.html
 */
...
const GROCO_JOURNAL_ARTICLES = [
  {
    ...
    shortDescription: "Kickstart your day with nutrient-packed organic bowls and quick 10-minute fresh smoothie recipes crafted for everyday wellness.",
    date: "May 12, 2026",
    readTime: "5 min read",
    author: "Dr. Maya Lin, Clinical Nutritionist",
    image: "https://images.unsplash.com/photo-1533089860892-a7c6f0a88666?auto=format&fit=crop&w=1200&q=80",
    badge: "FEATURED",
    tags: ["breakfast", "smoothie", "acai", "nutrition", "energy", "organic"],
    content: `
  ...
  },
  {
    ...
    shortDescription: "Explore how sourcing directly from local sustainable farms preserves vitamins, natural flavor, and supports our environment.",
    date: "May 10, 2026",
    readTime: "4 min read",
    author: "Elena Vance, Organic Agriculture Lead",
    image: "https://images.unsplash.com/photo-1610832958506-aa56368176cf?auto=format&fit=crop&w=1200&q=80",
    badge: "SUSTAINABLE",
    tags: ["farm", "organic", "produce", "sustainability", "harvest", "local"],
    content: `
  ...
  },
  {
    ...
    shortDescription: "Smart meal planning, seasonal shopping guides, and time-saving grocery organization strategies that cut your budget.",
    date: "May 06, 2026",
    readTime: "6 min read",
    author: "David Miller, Family Budget & Lifestyle Editor",
    image: "https://images.unsplash.com/photo-1542838132-92c53300491e?auto=format&fit=crop&w=1200&q=80",
    badge: "GUIDE",
    tags: ["shopping", "budget", "family", "grocery", "organization", "tips"],
    content: `
  ...
  },
  {
    ...
    shortDescription: "Delicious wholesome dinners made with fresh veggies and wholesome dairy that anyone can prepare in 15 minutes.",
    date: "May 02, 2026",
    readTime: "7 min read",
    author: "Chef Marcus Lin, Culinary Instructor",
    image: "https://images.unsplash.com/photo-1546069901-ba9599a7e63c?auto=format&fit=crop&w=1200&q=80",
    badge: "RECIPES",
    tags: ["recipes", "quick", "dinner", "cooking", "pasta", "mediterranean"],
    content: `
  ...
  },
  {
    ...
    slug: "organic-lifestyle-guide",
    category: "Lifestyle",
    categorySlug: "lifestyle",
    title: "The Essential Guide to Sustainable & Eco-Friendly Living",
    shortDescription: "Small daily swaps in your kitchen and home that reduce plastic waste and create a cleaner, greener home environment.",
    date: "Apr 28, 2026",
    readTime: "5 min read",
    author: "Sophia Sterling, Eco-Living Specialist",
    image: "https://images.unsplash.com/photo-1556228720-195a672e8a03?auto=format&fit=crop&w=1200&q=80",
    badge: "ECO",
    tags: ["lifestyle", "eco", "sustainability", "green", "zero-waste", "home"],
    content: `
  ...
  },
  {
    ...
    slug: "kitchen-pantry-hacks",
    category: "Smart Shopping",
    categorySlug: "shopping",
    title: "15 Smart Kitchen Hacks to Keep Organic Food Fresh Longer",
    shortDescription: "Simple storage techniques and humidity controls that extend produce shelf-life, save money, and eliminate food waste.",
    date: "Apr 22, 2026",
    readTime: "6 min read",
    author: "Groco Kitchen Research Lab",
    image: "https://images.unsplash.com/photo-1586201375761-83865001e31c?auto=format&fit=crop&w=1200&q=80",
    badge: "HACKS",
    tags: ["hacks", "storage", "freshness", "pantry", "avocado", "herbs"],
    content: `
  ...
  {
    id: "gut-health-superfoods",
    slug: "gut-health-superfoods",
    category: "Health & Nutrition",
    categorySlug: "health",
    title: "7 Organic Superfoods for Optimal Gut Health & Vitality",
    shortDescription: "Discover how fermented probiotics, prebiotic fiber, and organic leafy greens nurture your microbiome and boost immunity.",
    date: "Apr 16, 2026",
    readTime: "6 min read",
    author: "Dr. Maya Lin, Clinical Nutritionist",
    image: "https://images.unsplash.com/photo-1512621776951-a57141f2eefd?auto=format&fit=crop&w=1200&q=80",
    badge: "WELLNESS",
    tags: ["gut", "superfoods", "microbiome", "immunity", "kefir", "nutrition"],
    content: `
      <p class="article-lead">Over 70% of your immune system resides within your gut microbiome. Nurturing your intestinal flora with natural fermented foods and prebiotic plant fibers is the cornerstone of lifelong vitality.</p>

      <h2>1. Organic Kefir & Cultured Greek Yogurt</h2>
      <p>Live cultured dairy products are brimming with billions of beneficial lactobacillus strains that restore digestive flora after stress or antibiotic use.</p>

      <h2>2. Prebiotic Jerusalem Artichokes & Garlic</h2>
      <p>Prebiotic fibers serve as essential food for your beneficial gut bacteria. Incorporating fresh organic garlic, onions, and asparagus feeds good microbes and enhances nutrient absorption.</p>

      <div class="article-tip-box">
        <span class="tip-icon">🧪</span>
        <div class="tip-text">
          <strong>Microbiome Insight:</strong> Eating at least 30 different variety of organic plant foods each week increases gut microbial diversity significantly.
        </div>
      </div>
    `
  },
  {
    ...
    category: "Lifestyle",
    categorySlug: "lifestyle",
    title: "How to Build a Zero-Waste Organic Kitchen in 30 Days",
    shortDescription: "Practical step-by-step guidance on composting vegetable scraps, bulk pantry storage, and plastic-free grocery habits.",
    date: "Apr 10, 2026",
    readTime: "8 min read",
    author: "Sophia Sterling, Eco-Living Specialist",
    image: "https://images.unsplash.com/photo-1532634922-8fe0b757fb13?auto=format&fit=crop&w=1200&q=80",
    badge: "ZERO WASTE",
    tags: ["zero-waste", "compost", "kitchen", "eco", "recycling", "plastic-free"],
    content: `
      <p class="article-lead">Transforming your kitchen into a zero-waste sanctuary is one of the most rewarding steps toward sustainable living. Here is a simple 30-day framework to eliminate food scraps and plastic packaging.</p>

      <h2>Week 1: Countertop Composting</h2>
      <p>Set up an odorless stainless steel countertop compost bin for fruit peels, coffee grounds, and onion skins. Diverting organic waste from landfills reduces methane emissions dramatically.</p>

      <h2>Week 2: Glass Jar Pantry Organization</h2>
      <p>Buy dry beans, grains, and nuts in bulk using reusable cloth bags, then transfer them to clear glass mason jars for a beautiful, plastic-free pantry shelf.</p>

      <div class="article-tip-box">
        <span class="tip-icon">♻️</span>
        <div class="tip-text">
          <strong>Pro Scrap Hack:</strong> Store vegetable trimmings (carrot tops, celery bases, herb stems) in a freezer bag. Boil them once a month to create rich homemade organic vegetable broth!
        </div>
      </div>
    `
  }
